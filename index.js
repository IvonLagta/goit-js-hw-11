/* empty css                      */import{a as u,S as p,i}from"./assets/vendor-COEJfE63.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const m="54673230-281fb694487da15dcd571070d",y="https://pixabay.com/api/";u.defaults.baseURL=y;async function g(n,o=1){return(await u.get("",{params:{key:m,q:n,image_type:"photo",orientation:"horizontal",safesearch:!0,page:o,per_page:15}})).data}const d=document.querySelector(".gallery");document.querySelector(".loader");const f=document.querySelector(".loader-text"),h=new p(".gallery a",{captionsData:"alt",captionDelay:250});function b(n){const o=n.map(t=>`
    ...
    `).join("");d.insertAdjacentHTML("beforeend",o),h.refresh()}function L(){d.innerHTML=""}function w(){f.classList.remove("hidden")}function q(){f.classList.add("hidden")}const v=document.querySelector(".form");let c="",l=1;v.addEventListener("submit",function(n){n.preventDefault();const o=n.currentTarget.elements["search-text"].value.trim();if(!o){i.warning({message:"Please enter a search query!",position:"bottomCenter"});return}c=o,l=1,L(),w(),g(c,l).then(function(t){if(t.hits.length===0){i.info({message:"We're sorry, we couldn't find any images.",position:"bottomCenter"});return}b(t.hits)}).catch(function(){i.error({message:"Error fetching images.",position:"bottomCenter"})}).finally(function(){q()})});
